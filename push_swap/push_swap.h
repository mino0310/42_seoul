...
/*   Updated: 2021/06/10 08:50:31 by minhkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// error check
int							check-argv_to_stack(t_stack **a, int argc, char **argv);
...
int							sort_lee_then_three_a(t_stack **a, t_stack **b, t_op **op, int len);
int							sort_lee_than_three_b(t_stack **a, t_stack **b, t_op **op, int len);
